...
import LOGO from '../modules/tentangkami/assets/images/logo.png'
...
const Navbar = () => {
    ...
    return (
        <nav className="border-gray-200 w-full flex flex-row flex-wrap md:flex-nowrap items-center gap-4 md:gap-8 px-2 md:px-10 py-4 justify-between md:justify-start">
            ...
            <div className={`flex flex-col md:flex-row md:bg-white bg-slate-200 rounded-md justify-between items-start md:items-center md:inline-flex w-full ${toggleNavbar}`}>
